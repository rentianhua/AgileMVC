...
{
    /// <summary>
    /// The concrete <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextLocator" /> which use the <see cref="T:System.Web.SessionState.HttpSessionState" /> as the context storage.
    /// </summary>
    [ConfigurationElement(typeof(HttpSessionStateContextLocatorData))]
    public class HttpSessionStateContextLocator : ContextLocator
    {
        private const string SessionKeyOfContextItemKeys = "Smartac.SR.ApplicationContexts.SessionKeyOfContextItemKeys";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Smartac.SR.Core.ApplicationContexts.HttpSessionStateContextLocator" /> class.
        /// </summary>
        ...
        /// <returns>
        /// The <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" /> object to get.
        /// </returns>
        ...
        /// <returns>
        /// true if the <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" /> already exists; otherwise, false.
        /// </returns>
