...
using Smartac.SR.Core.ApplicationContexts.Configuration;
...
namespace Smartac.SR.Core.ApplicationContexts
{
    ...
    public sealed class ApplicationContext
    {
        ...
        /// </summary>
        public const string ContextHeaderNamespace = "http://www.smartac.co/";
        ...
        /// </summary>
        public const string ContextHttpHeaderName = "Smartac.SR.Core.Applicationcontext";
        private const string KeyofUserId = "Smartac.SR.ApplicationContexts.UserId";
        private const string KeyofUserName = "Smartac.SR.ApplicationContexts.UserName";
        private const string KeyofTransactionId = "Smartac.SR.ApplicationContexts.TransactionId";
        private const string KeyofTimeZone = "Smartac.SR.ApplicationContexts.TimeZone";
        private const string KeyofCulture = "Smartac.SR.ApplicationContexts.Culture";
        private const string KeyofUICulture = "Smartac.SR.ApplicationContexts.UICulture";
        private const string KeyofSessionId = "Smartac.SR.ApplicationContexts.SessionId";
        ...
        /// <summary>
        /// Gets the <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" /> with the specified key.
        /// </summary>
        /// <value>The <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" />.</value>
        ...
        /// <summary>
        /// Gets the value of the <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" /> with the specified key.
        /// </summary>
        /// <typeparam name="TValue">The type of the value of <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" /></typeparam>
        /// <param name="key">The key of the <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" /> to get.</param>
        /// <returns>The value of the <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" /> to get. </returns>
        ...
        /// Sets the context.
        /// </summary>
        /// <param name="key">The key of the <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" />.</param>
        /// <param name="value">The value of the <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextItem" />.</param>
