...
{
    /// <summary>
    ///  The <see cref="T:Smartac.SR.Core.ApplicationContexts.ContextLocator" /> which use the <see cref="T:System.Runtime.Remoting.Messaging.CallContext" /> as the context storage.
    /// </summary>
