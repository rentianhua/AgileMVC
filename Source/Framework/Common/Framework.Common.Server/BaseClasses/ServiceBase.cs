...
namespace Smartac.SR.Framework.Common.Server.BaseClasses
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:NCS.IConnect.Architecture.Server.ServiceBase`1" /> class.
        /// </summary>
